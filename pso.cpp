...
double objFunction(ZPSO_Partical &partical)
{
	dot toComplex(partical._position[0], partical._position[1]);

	double prize_C
	=mappointer.Prize_Func_commu(mappointer.XY, mappointer.XZ, Param_Communicate_Distance);
	return prize_C;
}